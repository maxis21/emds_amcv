        ...
        <div class="body-container container-fluid d-flex">
            <div class="card-group d-flex" style="margin: auto !important">
                <div class="dash-card dash-1">
                    <h5 style="display: flex; flex-direction: column; gap: 0.4rem;">DEPARTMENTS DOCUMENTS<br><span
                ...
                <div class="dash-card dash-3">
                    <h5 style="display: flex; flex-direction: column; gap: 0.4rem;">DOCUMENTS VERSIONS<br><span
                            style="font-size: 25px;">{{ $totalUploads }}</span> </h5>
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor"
