...
<div class="container-fluid d-flex" style="justify-content: space-between;">
    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%">
        ...
        <div class="breadcrumbs">
            ...
            <a href="{{ route('userFolders.show', ['name' => $breadcrumb->name, 'folderId' => $breadcrumb->id]) }}"> &nbsp;> {{ $breadcrumb->name }} </a>
            @endforeach
        </div>
        ...
        <div class="file-box">
            <table id="dataTable">
                ...
                <tbody>
                    ...
                    <tr class="folder" data-folder-id="{{ $folder->id }}" data-href="{{ route('userFolders.show', ['name' => $folder->name, 'folderId' => $folder->id]) }}" style="cursor: pointer;">
