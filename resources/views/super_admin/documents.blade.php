        ...
        <div style="display: flex; justify-content: space-between; align-items: center; width: 100%">
            ...
            <div class="breadcrumbs">
                ...
                @foreach ($breadcrumbs as $breadcrumb)
                    <a href="{{ route('folders.show', ['name' => $breadcrumb->name, 'folderId' => $breadcrumb->id]) }}">
                        &nbsp;> {{ $breadcrumb->name }} </a>
                @endforeach
            </div>
                ...
                <table id="dataTable">
                    ...
                    <tbody>
                        @foreach ($folders as $folder)
                            <tr class="folder" data-folder-id="{{ $folder->id }}"
                                data-href="{{ route('folders.show', ['name' => $folder->name, 'folderId' => $folder->id]) }}"
                        ...
                        @foreach ($documents as $document)
                            ...
                            @endphp
                            <tr class="docu" data-docu-id="{{ $document->id }}"
                                data-dhref="{{ route('view.file', ['originalFile' => $originalFile]) }}"
