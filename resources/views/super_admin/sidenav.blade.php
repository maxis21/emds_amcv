    ...
    <div class="side-content">
        ...
        <div class="nav-menu">
            <ul class="menu-content">
                ...
                <li>
                    <a href="#toDepartment">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-building-fill" viewBox="0 0 16 16">
                ...
                <li>
                    <a id="open-modal-btn" onclick="location.href='#modal-container'">
